...
<<land_use_comparison, fig.width = tall_height, fig.height = small_width, eval = include_plots, out.extra='angle=90', out.width= "180%">>=
@
...
<<forest_type_comparison, fig.width = tall_height, fig.height = small_width, eval = include_plots, out.extra='angle=90', out.width= "180%">>=
@
